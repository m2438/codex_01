...
> **PCブラウザ向け16:9画像版：** [`NISSAN_CRE_DASHBOARD_16x9.svg`](./NISSAN_CRE_DASHBOARD_16x9.svg)<br>
> 1500×900の16:9画面比率で、Webブラウザやプレゼン資料にそのまま貼れる日本語表記の洗練版ダッシュボード画像です（テキスト差分管理可能なSVG形式）。

> **GitHubで直接開くための再出力版：** [`assets/nissan-cre-dashboard-16x9.svg`](./assets/nissan-cre-dashboard-16x9.svg)<br>
> GitHub上で見つけやすいように、`assets/` 配下へ小文字ハイフン形式のSVGファイル名でも再出力しています。
