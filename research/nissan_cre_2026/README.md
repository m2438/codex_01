...
> **スマホのCodex画面で読む場合：** [`MOBILE_DASHBOARD.md`](./MOBILE_DASHBOARD.md)<br>
> ダウンロードやHTTPサーバーなしで読める、縦スクロール前提のMarkdown版を追加しています。


## スマホ即読版（Codex画面用）

**総合評価：92 / 100（最優先ターゲット）**
...
- **最重要シグナル：** 車両生産工場17→10への統合、固定資産売却収入1,767億円、固定資産売却益1,191億円。
- **最優先拠点：** 追浜工場（車両生産終了・九州移管に伴う跡地構想、売却、再開発、地域調整）。
- **提案軸：** 土地/資産売却、用途転換・跡地企画、環境・土壌DD、建設/移転PM、リース最適化。
- **詳細版：** `research/nissan_cre_2026/MOBILE_DASHBOARD.md` をCodex上で開けば、スマホ向けに縦スクロールで読めます。
